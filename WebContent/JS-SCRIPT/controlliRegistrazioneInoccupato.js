...
function checkAll() {
	if(!checkNome() || !checkCognome() || !checkCitta() || !checkResidenza() || !checkDataNascita() || !checkEmail() || !checkUsername() || !checkPass() || !checkConfPass() || !checkCurriculum() || !checkTrattamentoDati()) {
